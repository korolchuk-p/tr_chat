...
def index():
    ...
    if 'token' not in session:
        ...
        logs.add_to_log("give rnd token: " + str(session['token']))
    date = session['date']
...
def add_mes():
    logs.add_to_log("receive method:" + request.method)
    ...
    logs.add_to_log("mes = " + str(mes))
    logs.add_to_log("author = " + str(author))
